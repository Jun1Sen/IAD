...
def random_forest():
    ...
    # Целевая переменная: Severity_of_Consequences
    # Признаки: Alcohol_Intoxication_Degree, Technical_Faults, Weather_Condition
    ...
    # Вычисление полноты, точности и F1-меры
