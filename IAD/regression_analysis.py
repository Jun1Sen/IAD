...
def regression_analysis():
    ...
    print("Средняя абсолютная ошибка (MAE) на тестовом наборе данных:", mae)

    # Вычисляем среднеквадратическую ошибку (MSE)
    mse = mean_squared_error(y_test, y_pred)
    print("Среднеквадратическая ошибка (MSE) на тестовом наборе данных:", mse)
    ...
    # Отображаем график
    plt.show()
    plt.savefig('РЕГРЕССИОННЫЙ АНАЛИЗ.png')
